  ...
  const COUNTRIES = [
    ...
    { code: 'PR', name: 'Puerto Rico', capital: 'San Juan', langs: 'Español · Inglés', region: 'caribe', pop: '3.2M', currency: 'Dólar', dish: 'Mofongo · Arroz con gandules · Lechón', figures: 'Julia de Burgos · Bad Bunny · Ricky Martin', fact: 'Estado libre asociado a EE.UU. Sus habitantes son ciudadanos estadounidenses pero la cultura es profundamente latina.',
    ...
    { code: 'ES', name: 'España', capital: 'Madrid', langs: 'Español · Catalán · Gallego · Euskera', region: 'europa', pop: '48M', currency: 'Euro', dish: 'Paella · Tortilla · Jamón ibérico · Tapas', figures: 'Cervantes · Picasso · Lorca · Almodóvar', fact: 'Origen del idioma español. Cuna del flamenco y de Don Quijote, la novela moderna por excelencia.',
    ...
    { code: 'UY', name: 'Uruguay', capital: 'Montevideo', langs: 'Español', region: 'america', pop: '3.5M', currency: 'Peso uruguayo', dish: 'Asado · Chivito · Mate', figures: 'Eduardo Galeano · Mario Benedetti · José Mujica', fact: 'Pequeño pero progresista: pionero en derechos sociales en América Latina. El mate es prácticamente sagrado.',
      ...
      <div class="country-card" onclick="openCountry('${c.code}')">
        ...
        <div class="country-info">
          <div class="country-info-text">
            ...
            ${c.langs ? `<div class="langs">🗣️ ${c.langs}</div>` : ''}
          </div>
          ${typeof countryShapeSvg === 'function' ? countryShapeSvg(c.code) : ''}
        </div>
      </div>
    `).join('');
  }
  ...
  function openCountry(code) {
    ...
    document.getElementById('modalBody').innerHTML = `
      ...
      ${c.langs ? `<div class="modal-section">
        <h5>🗣️ Languages</h5>
