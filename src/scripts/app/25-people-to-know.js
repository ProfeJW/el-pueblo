  ...
  const PEOPLE = [
    ...
    { name: 'Emiliano Zapata', country: 'MX', role: 'Revolutionary', img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Emiliano_Zapata4.jpg?width=400', blurb: 'Peasant leader of the Mexican Revolution from Morelos. Fought for land reform under the slogan "Tierra y Libertad." Assassinated in 1919; now a near-mythic symbol of resistance.', credit: 'Wikimedia / Public Domain' },
    { name: 'Pancho Villa', country: 'MX', role: 'Revolutionary', img: 'https://commons.wikimedia.org/wiki/Special:FilePath/Pancho_villa_horseback.jpg?width=400', blurb: 'A former bandit turned brilliant cavalry commander in the north during the Mexican Revolution. Led the Division del Norte and became a folk hero. Assassinated in 1923.', credit: 'Wikimedia / Public Domain' },
