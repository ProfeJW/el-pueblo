  ...
  function loadState() {
    ...
    try {
      ...
      // Game best scores
      ['game_best_days', 'game_best_dates', 'game_best_numbers-small', 'game_best_numbers-mid', 'game_best_numbers-big', 'game_best_time', 'game_best_weather', 'game_best_tu-usted', 'game_best_dialogo', 'game_best_adjectives', 'game_best_reflexives', 'game_best_object-pronouns', 'game_best_plurals', 'game_best_vocab-type', 'game_best_vocab-mc'].forEach(k => {
        if (parsed[k] != null) s[k] = parsed[k];
      });
  ...
  function saveState() {
    ...
    try {
      const toSave = {
        ...
        game_best_dialogo: STATE.game_best_dialogo || 0,
